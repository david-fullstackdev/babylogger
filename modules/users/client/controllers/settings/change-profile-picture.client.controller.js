(function () {
  ...
  ChangeProfilePictureController.$inject = ['$timeout', '$state', 'Authentication', 'Upload', 'Notification'];

  function ChangeProfilePictureController($timeout, $state, Authentication, Upload, Notification) {
    var vm = this;
