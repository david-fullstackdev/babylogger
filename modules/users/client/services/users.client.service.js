(function () {
  ...
  function UsersService($resource) {
    var Users = $resource('api/users', {}, {
      ...
      resetPrimaryUserPwd: {
        method: 'POST',
        url: 'api/auth/reset_primary_user_pwd'
      }
    });
    ...
    angular.extend(Users, {
      ...
      updateuserProfile: function (details) {
        return this.updateProfile(details).$promise;
      },
      resetPrimaryUserPassword: function () {
        return this.resetPrimaryUserPwd().$promise;
      }
    });
